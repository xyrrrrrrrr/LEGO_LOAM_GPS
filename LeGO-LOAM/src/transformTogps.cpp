...
private:
    ...
    pcl::PointCloud<pcl::PointXYZ> laserCloudGPS;
    ...
    pcl::PointCloud<pcl::PointXYZ> gps_pc;
    // gps数据队列互斥锁
...
public:
    TransformTogps(){
    pcl::io::loadPCDFile<pcl::PointXYZ>("/home/t/pc_map/expect_gps_map.pcd", origin_pc);
    // create a gps subscriber
    subGPS = nh.subscribe("/gpsdemo", 1000, &TransformTogps::gpsHandler, this);  
    //  ROS_INFO("\033[1;32m---->\033[0m Transforming"); 
